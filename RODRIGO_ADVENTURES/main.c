...
int main(){
    ...
    if (escolha == 4){
        ...
        if (escolha == 3 ){
            ...
            if (escolha ==1){
                printf("ele leva um balde de agua gelada onde ele fica preso com o balde na cabe�a e morre\n");
            }
